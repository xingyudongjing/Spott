...
export function itineraryCopy(locale: Locale) {
  ...
  return {
    ...
    waitlistReviewEyebrow: text("itinerary.waitlistReviewEyebrow"),
    waitlistReviewTitle: text("itinerary.waitlistReviewTitle"),
    waitlistReviewBody: text("itinerary.waitlistReviewBody"),
    waitlistEvent: text("itinerary.waitlistEvent"),
    waitlistParty: text("itinerary.waitlistParty"),
    waitlistPoints: text("itinerary.waitlistPoints"),
    waitlistExpiry: text("itinerary.waitlistExpiry"),
    waitlistPointsAmount: text("itinerary.waitlistPointsAmount"),
    waitlistNoHiddenFees: text("itinerary.waitlistNoHiddenFees"),
    waitlistPointBoundary: text("itinerary.waitlistPointBoundary"),
    waitlistCancel: text("itinerary.waitlistCancel"),
    waitlistConfirm: text("itinerary.waitlistConfirm"),
    waitlistConfirming: text("itinerary.waitlistConfirming"),
    waitlistQuoteLoading: text("itinerary.waitlistQuoteLoading"),
    waitlistQuoteInvalid: text("itinerary.waitlistQuoteInvalid"),
    waitlistAcceptFailed: text("itinerary.waitlistAcceptFailed"),
    waitlistChanged: text("itinerary.waitlistChanged"),
    waitlistRefreshFailed: text("itinerary.waitlistRefreshFailed"),
    waitlistRetryRefresh: text("itinerary.waitlistRetryRefresh"),
    waitlistRefreshingFacts: text("itinerary.waitlistRefreshingFacts"),
    waitlistAcceptanceRefreshing: text("itinerary.waitlistAcceptanceRefreshing"),
    waitlistAcceptanceRefreshFailed: text("itinerary.waitlistAcceptanceRefreshFailed"),
    waitlistRetryAcceptanceRefresh: text("itinerary.waitlistRetryAcceptanceRefresh"),
    waitlistAcceptanceRefreshed: text("itinerary.waitlistAcceptanceRefreshed"),
