...
| `03-full-page-rhythm-desktop.png` | 同名 | 1440×5938 | `f69768b0cfc221d9e0cd1e19942e3e76b0d4f989c55964ba0bdb8a0caf9bfe8e` | 完整官网的全页章节节奏，不替代分节细节 | 最终中文官网真实浏览器渲染；产品图均来自冻结来源清单 | 先滚动完成 7/7 懒加载图片解码，再回到 `scrollY=0`、`BODY` 焦点和隐藏 skip link 后捕获；实现冻结于 `be1add0adc47a5c9a4e389b45309bea44b5cc2fc` | `PROPOSED` | 待产品所有者查看部署预览后确认 |
...
| `05-community-1440x900.png` | 同名 | 1440×900 | `47789c80ca8359a9f6e6e1a46a48c711612df43ef9f02097015cde499a091fb6` | 真实社区目录、完整安全区与清晰层级 | 当前中文官网真实 Community 分节，内嵌当前 1206×2622 iOS 模拟器捕获且使用 `contain` | 最终构建真实浏览器捕获；section top=69、header=0…69、7/7 图片解码完成；实现冻结于 `be1add0adc47a5c9a4e389b45309bea44b5cc2fc` | `PROPOSED` | 待产品所有者查看部署预览后确认 |
...
| `06-host-1440x900.png` | 同名 | 1440×900 | `3ba1142be4e23c9aa765f46ae5108227cbb817c963e3a61a694d8c704884b916` | 只显示当前真实主办方活动管理能力 | 当前中文官网真实 Host 分节；产品面板来自真实 `StudioEventsClient` 冻结捕获，不再使用概念占位 UI | 最终构建真实浏览器捕获；section top=69、header=0…69、7/7 图片解码完成；实现冻结于 `be1add0adc47a5c9a4e389b45309bea44b5cc2fc` | `PROPOSED` | 待产品所有者查看部署预览后确认 |
