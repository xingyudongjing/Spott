...
function itineraryRow(overrides: Record<string, unknown> = {}) {
  return {
    ...
    offer_expires_at: null,
    payment_self_reported_at: new Date('2026-07-16T01:00:00.000Z'),
    payment_confirmed_at: new Date('2026-07-16T01:30:00.000Z'),
    ...
    expect(result).toEqual({
      items: [{
        registration: {
          ...
          ticketTypeId: null,
          offerExpiresAt: null,
          paymentSelfReportedAt: '2026-07-16T01:00:00.000Z',
          paymentConfirmedAt: '2026-07-16T01:30:00.000Z',
