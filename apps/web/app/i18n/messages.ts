...
const zh = {
  ...
  "discover.mapError": "地图暂时不可用，已返回列表。",
...
const ja: Record<MessageKey, string> = {
  ...
  "nav.primary": "メインナビゲーション", "nav.mobile": "モバイルナビゲーション", "nav.region": "エリア：{region}", "nav.regionValue": "日本",
  ...
  "discover.promise": "本当に参加したいイベントに出会う", "discover.support": "日時、場所、料金、空席を確認してから出かけましょう。", "discover.format": "開催形式", "discover.price": "料金", "discover.language": "言語", "discover.moreFilters": "その他の条件", "discover.list": "リスト", "discover.map": "地図", "discover.sortTime": "日時順", "discover.startDate": "開始日", "discover.endDate": "終了日", "discover.refreshing": "イベントを更新中…", "discover.staleError": "イベントを更新できませんでした。現在の結果は引き続き閲覧できます。", "discover.paginationError": "続きの結果を表示できません。しばらくしてからお試しください。", "discover.mapError": "地図を利用できないため、リストに戻りました。", "discover.mapRegion": "イベントマップ", "discover.approximate": "おおよそのエリア", "region.all": "日本全国", "region.tokyo": "東京", "region.kanagawa": "神奈川", "region.saitama": "埼玉", "region.chiba": "千葉", "region.osaka": "大阪", "region.kyoto": "京都", "filter.allFormats": "すべての形式", "filter.allPrices": "すべての料金", "filter.paid": "有料", "filter.allLanguages": "すべての言語", "filter.allCategories": "すべてのカテゴリー", "filter.categoryWalk": "まち歩き", "filter.categoryMusic": "音楽", "filter.categoryFood": "フード・カフェ", "filter.categoryOutdoor": "アウトドア", "filter.categoryArt": "アート・ものづくり", "filter.categoryLanguage": "言語交換", "filter.categorySports": "スポーツ", "filter.categoryGames": "ゲーム", "filter.categoryLearning": "学び", "filter.categoryWellness": "ウェルネス", "filter.categoryNetworking": "交流会",
  "event.spots": "残り {count}", "event.waitlist": "キャンセル待ち", "event.waitlistAvailable": "キャンセル待ち可", "event.full": "満員", "event.unlimited": "定員なし", "event.register": "参加申し込み", "event.joinWaitlist": "キャンセル待ちに登録", "event.viewRegistration": "申込を確認", "event.favorite": "保存", "event.favorited": "保存済み", "event.share": "シェア", "event.calendar": "カレンダーに追加", "event.followHost": "主催者をフォロー", "event.loginToFavorite": "ログインして保存",
...
const en: Record<MessageKey, string> = {
  ...
  "nav.primary": "Primary navigation", "nav.mobile": "Mobile navigation", "nav.region": "Region: {region}", "nav.regionValue": "Japan",
